...
public class PaymentControllerTest extends JcrmDnioProject2ApplicationTest {
    ...
    public void POSTTestPaymentController() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.post("http://localhost:8080/api/v1/payment_method")
                ...
                .content(
                        "{\"code\": \"912123\", \"description\": \"testando 23\", \"interestRate\": 0.5, \"tax\": 0.6}"))
    ...
    public void POSTTestPaymentControllerErrorCodeLength() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.post("http://localhost:8080/api/v1/payment_method")
                .contentType(MediaType.APPLICATION_JSON)
                .content(
                        "{\"code\": \"91234\", \"description\": \"testando 123\", \"interestRate\": 0.5, \"tax\": 0.6}"))
    ...
    public void POSTTestPaymentControllerErrorDescriptionLength() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.post("http://localhost:8080/api/v1/payment_method")
                .contentType(MediaType.APPLICATION_JSON)
                .content(
                        "{\"code\": \"912122\", \"description\": \"testando 123 testando 123 testando 123 testando 123 testando 123 testando 123testando123testando 123testando 123testando 123testando123testando 123testando123testando 123 \", \"interestRate\": 0.1, \"tax\": 0.3}"))
                .andExpect(MockMvcResultMatchers.status().isBadRequest());
    }
    ...
    public void POSTTestPaymentControllerErrorInterestRateDecimal() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.post("http://localhost:8080/api/v1/payment_method")
                .contentType(MediaType.APPLICATION_JSON)
                .content(
                        "{\"code\": \"912122\", \"description\": \"testando 123\", \"tax\": 0.5, \"interestRate\": -1}"))
                .andExpect(MockMvcResultMatchers.status().isBadRequest());
    }
    ...
    public void POSTTestPaymentControllerErrorTaxDecimal() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.post("http://localhost:8080/api/v1/payment_method")
                .contentType(MediaType.APPLICATION_JSON)
                .content(
                        "{\"code\": \"912122\", \"description\": \"testando 123\", \"tax\": 10, \"interestRate\": 0.5}"))
                .andExpect(MockMvcResultMatchers.status().isBadRequest());
    }
    ...
    public void PUTTestPaymentController() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.put("http://localhost:8080/api/v1/payment_method/edit")
                .contentType(MediaType.APPLICATION_JSON)
                .content(
                        "{ \"id\": 10, \"code\": \"123123\", \"description\": \"testando 123\", \"interestRate\": 0.5, \"tax\": 0.5}"))
                .andExpect(MockMvcResultMatchers.status().is2xxSuccessful());
    }
    ...
    public void PUTPaymentControllerErrorDescription() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.put("http://localhost:8080/api/v1/payment_method/edit")
                .contentType(MediaType.APPLICATION_JSON)
                .content(
                        "{ \"id\": 10, \"code\": \"123123\", \"description\": \"testando 123 123 123sdasdq eqw 09j00 00q9w jqw nwq h9q0w jdq09wd jqw90jd90 qw0djqw09 djqw90 jdqw 9djqw90djw09q jd09qwj d9q0wjd0 asdad\", \"interestRate\": 0.5, \"tax\": 0.5}"))
                .andExpect(MockMvcResultMatchers.status().isBadRequest());
    }
    ...
    public void PUTPaymentControllerErrorTax() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.put("http://localhost:8080/api/v1/payment_method/edit")
                .contentType(MediaType.APPLICATION_JSON)
                .content(
                        "{ \"id\": 10, \"code\": \"123123\", \"description\": \"testando 123\", \"interestRate\": 0.5, \"tax\": 15}"))
                .andExpect(MockMvcResultMatchers.status().isBadRequest());
    }
    ...
    public void PUTPaymentControllerErrorInterestRate() throws Exception {
        this.mockMvc.perform(MockMvcRequestBuilders.put("http://localhost:8080/api/v1/payment_method/edit")
                .contentType(MediaType.APPLICATION_JSON)
                .content(
                        "{ \"id\": 10, \"code\": \"123123\", \"description\": \"testando 123\", \"interestRate\": -1, \"tax\": 0.5}"))
                .andExpect(MockMvcResultMatchers.status().isBadRequest());
    }
